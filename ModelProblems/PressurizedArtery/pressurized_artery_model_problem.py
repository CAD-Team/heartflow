...
def BoundaryFittedStudy(L, Nt, Nr, Nu, Nv, eps, nu_b, E_b, nu_a, E_a, nu_h, E_h, ri, ro, pi, basis_degree, gauss_degree, model_problem_name, study_name = "boundary_fitted"):
...
def main():
    ...
    #Nr = [30,60,120]
    #Nt = [30,60,120]
    #BoundaryFittedStudy(L, Nt, Nr, Nu, Nv, eps, nu_b, E_b, nu_a, E_a, nu_h, E_h, ri, ro, pi, basis_degree, gauss_degree, model_problem_name)
