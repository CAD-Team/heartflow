...
def main():
	...
	omega.K = omega_topo.projection(omega.K, onto=omega_topo.basis('spline',degree=2), geometry=omega.x, ptype=ptype, ischeme='gauss{}'.format(2),solver='cg', atol=1e-10, precon='diag')
